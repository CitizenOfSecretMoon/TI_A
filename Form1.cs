                ...
                case 0:
                    {
                        ...
                        if (rbEncrypt.Checked)
                            ...
                            MessageBox.Show("Шифр или расшифровка???", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                    break;
                ...
                case 2:
                    {
                        ...
                        if (turning_grille_cipher.CheckKey(key))
                        {
                            ...
                            MessageBox.Show("Неверный ключ", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                    break;
